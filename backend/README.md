...
- **Multi-tenant Architecture** with customer isolation and API key authentication
...
#### 2. API Key Authentication (Customer)
```bash
...
- `POST /api/customer/verify-email` - Verify email address
- `GET /api/customer/profile` - Get customer profile
- `PUT /api/customer/profile` - Update customer profile
- `POST /api/customer/change-password` - Change password

#### Project Management
- `GET /api/customer/projects` - List customer projects
- `POST /api/customer/projects` - Create new project
- `GET /api/customer/projects/:id` - Get project details
- `PUT /api/customer/projects/:id` - Update project
- `DELETE /api/customer/projects/:id` - Delete project
...
- **Customer**: API consumers with projects
- **Project**: Customer's 3D visualization projects
- **ApiKey**: Authentication keys for customers
- **ResourceCategory**: Categories for 3D resources
- **Resource**: 3D models, textures, and assets
- **CustomerCategoryPermission**: Access control for resources
...
- **API Keys**: For customer authentication with scope-based permissions
- **Role-based Access**: Different permission levels for admins
- **Scope-based Access**: Fine-grained resource permissions for customers
